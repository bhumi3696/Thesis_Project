###########################################AMP#####################
high_d1 <- read.csv("D:/SEM 3/Datasets/GTmatrix/high/Data2.csv")
...
low_d1 <- read.csv("D:/SEM 3/Datasets/GTmatrix/low/Data2.csv")
...
medium_d1 <- read.csv("D:/SEM 3/Datasets/GTmatrix/medium/Data2.csv")
...
df$type_website <- 1
#########################################Non-AMP######################
non_amp_d1 <- read.csv("D:/SEM 3/Datasets/GTmatrix/Non-AMP/Data2.csv")
...
################################################################
write.csv(high_data, file = "D:/SEM 3/Datasets/GTmatrix/final/data/data2.csv",row.names=FALSE)
...
#############scatter plot#########################
pairs(PageSpeed_Grade ~ Yslow_Grade+Onload_ms+Onload_Times+Total_Size_bytes+Fully_loaded_ms+Total_Requests,data=high_data, 
      upper.panel=panel.smooth,pch=".", span=0.1,col.line="blue")
##############correlation#############################
library(corrplot)
df <- high_data[,c(2,3,5,6,12,13,14,15,16,17,21,25)]
